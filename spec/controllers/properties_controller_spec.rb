...
describe PropertiesController do
  ...
  let(:valid_attributes) { { "address1" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved property as @property" do
        ...
        post :create, {:property => { "address1" => "invalid value" }}, valid_session
        assigns(:property).should be_a_new(Property)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested property" do
        ...
        Property.any_instance.should_receive(:update).with({ "address1" => "MyString" })
        put :update, {:id => property.to_param, :property => { "address1" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the property as @property" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Property.any_instance.stub(:save).and_return(false)
        put :update, {:id => property.to_param, :property => { "address1" => "invalid value" }}, valid_session
        assigns(:property).should eq(property)
      end
